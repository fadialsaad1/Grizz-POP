...
INSERT INTO events (title, description, location, date, time, status, setupList, organizerID) VALUES
('Charity Run', 'Community 5K fundraising event', 'City Park', '2025-05-12', '09:00:00', 'Scheduled', 'Setup tents, water stations', 1),
('Music Festival', 'Live music and food trucks', 'Downtown Plaza', '2025-06-20', '14:00:00', 'Planned', 'Stage setup, sound check', 1),
('Tech Expo', 'Technology innovation showcase', 'Convention Center', '2025-07-15', '10:00:00', 'Planned', 'Booth arrangements, AV setup', 1),
('Cleanup Drive', 'Neighborhood cleanup event', 'Greenwood Park', '2025-04-10', '08:00:00', 'Completed', 'Trash bags, gloves distribution', 1),
('Art Exhibit', 'Local artists display their work', 'Art Hall', '2025-08-22', '11:00:00', 'Planned', 'Display setup, lighting', 1),
